...
void hd44780_initialize(void) {
	...
	hd44780_command(HD44780_FUNCTION_SET | HD44780_FUNCTION_SET_8BIT | HD44780_FUNCTION_SET_2LINE);
	_delay_us(100);
	...
	hd44780_command(HD44780_ENTRY_MODE_SET | HD44780_ENTRY_MODE_SET_INCREMENT);
	_delay_us(53);
